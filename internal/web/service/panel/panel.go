...
const (
	panelUpdaterURL      = "https://raw.githubusercontent.com/pcpapc172/3x-ui/main/update.sh"
...
func fetchPanelRelease(tag string) (*service.Release, error) {
	url := "https://api.github.com/repos/pcpapc172/3x-ui/releases/latest"
	if tag != "" {
		url = "https://api.github.com/repos/pcpapc172/3x-ui/releases/tags/" + tag
	}
